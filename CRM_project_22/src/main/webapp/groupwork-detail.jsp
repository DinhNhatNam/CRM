	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="white-box">
							<div class="col-in row">
								...
								<div class="col-md-6 col-sm-6 col-xs-6">
									<h3 class="counter text-right m-t-15 text-danger">${listcount.get(0)}
										%</h3>
								</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="white-box">
							<div class="col-in row">
								...
								<div class="col-md-6 col-sm-6 col-xs-6">
									<h3 class="counter text-right m-t-15 text-megna">${listcount.get(2)}
										%</h3>
								</div>
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="progress">
					...
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="white-box">
							<div class="col-in row">
								...
								<div class="col-md-6 col-sm-6 col-xs-6">
									<h3 class="counter text-right m-t-15 text-primary">${listcount.get(1)}
									</h3>
								</div>
								<div class="col-md-12 col-sm-12 col-xs-12">
									<div class="progress">
				...
				<c:if test="${listcheck!=null}">
					<c:forEach items="${listcheck}" var="i">
						<div class="row">
							<div class="col-xs-12">
								<a href="#" class="group-title"> <img width="30"
									src="plugins/images/users/pawandeep.jpg" class="img-circle" />
									<span>${i.getId_nguoidung().getFullname() } </span>
								</a>
							</div>
							<div class="col-md-4">
								<div class="white-box">
									<h3 class="box-title">Chưa thực hiện</h3>
									<c:if test="${listcongviec!=null}">
										<c:forEach items="${listcongviec}" var="a">
											<c:if
												test="${i.getId_nguoidung().getId()==a.getId_NguoiDung().getId()}">
												<c:if test="${a.getId_CongViec().getTrangthai().getId()==3}">
													<div class="message-center">
														<a href="#">
															<div class="mail-contnet">
																<h5>
																	<c:out value="${a.getId_CongViec().getName()}"></c:out>
																</h5>

																<span class="mail-desc"> </span> <span class="time">
																	<c:out value="${a.getId_CongViec().getNgaybatdau()}"></c:out>
																	to <c:out
																		value="${a.getId_CongViec().getNgayketthuc()}"></c:out>
																</span>
								...
								<div class="white-box">
									...
									<c:if test="${listcongviec!=null}">
										<c:forEach items="${listcongviec}" var="a">
											<c:if
												test="${i.getId_nguoidung().getId()==a.getId_NguoiDung().getId()}">
												<c:if test="${a.getId_CongViec().getTrangthai().getId()==2}">
													<div class="message-center">
														<a href="#">
															<div class="mail-contnet">
																<h5>
								...
								<div class="white-box">
									...
									<c:if test="${listcongviec!=null}">
										<c:forEach items="${listcongviec}" var="a">
											<c:if
												test="${i.getId_nguoidung().getId()==a.getId_NguoiDung().getId()}">
												<c:if test="${a.getId_CongViec().getTrangthai().getId()==1}">
													<div class="message-center">
														<a href="#">
															<div class="mail-contnet">
																<h5>

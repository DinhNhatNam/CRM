						...
						<div class="white-box">
							<form action="<c:url value='/groupwork-edit'/>" method="post"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" placeholder="Tên công việc" name="tenduan"
										value="${namedn}"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="date" placeholder="yyy-mm-dd" name="ngaybatdau"
										value="${nbatdau}"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="date" placeholder="yyy-mm-dd" name="ngayketthuc"
										value="${nketthuc}"
											class="form-control form-control-line">
									</div>
								</div>

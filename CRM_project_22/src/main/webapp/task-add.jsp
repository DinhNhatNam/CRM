						...
						<div class="white-box">
							<form class="form-horizontal form-material"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<select class="form-control form-control-line" name="id_duan">
											<c:if test="${listGW!=null}">
												<c:forEach items="${listGW}" var="i">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="text" placeholder="Tên công việc"
											name="tencongviec" class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<select class="form-control form-control-line"
											name="id_nguoidung">
											<c:if test="${listnd!=null}">
												<c:forEach items="${listnd}" var="i">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="date" placeholder="dd/MM/yyyy" name="ngaybatdau"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="date" placeholder="dd/MM/yyyy" name="ngayketthuc"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">

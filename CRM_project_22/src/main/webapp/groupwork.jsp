							...
							<div class="table-responsive">
								<table class="table" id="example">
									...
									<tbody>
										...
										<c:if test="${listgroupwork!=null}">
											<c:forEach items="${listgroupwork}" var="i">
												<tr>
													<td><c:out value="${i.getId()}" /></td>

													<td><c:out value="${i.getName()}" /></td>
													<td><c:out value="${i.getNgaybatdau()}" /></td>
													<td><c:out value="${i.getNgaykethuc()}" /></td>
													<td><a href="groupwork-edit?id=${i.getId()}"
														class="btn btn-sm btn-primary">Sửa</a> 
														<a href="#"
														class="btn btn-sm btn-danger">Xóa</a> 
														<a
														href="groupwork-detail?id=${i.getId()}"

                                ...
                                <table class="table" id="example">
                                    ...
                                    <c:forEach items="${listUser}" var="User">
                                    	...
                                    	<tr>
                                            ...
                                            <td>${User.getEmail()}</td>
                                            <td>${User.getLoaithanhvien().getName()}</td>
                                            <td>
                                                <a href="user-update?id-user=${User.getId()}" class ="btn btn-sm btn-primary">Sửa</a>
                                                <a href="#" id-user="${User.getId()}" class ="btn btn-sm btn-danger btn-xoa">Xóa</a>
                                                <a href="user-detail?id-user=${User.getId()}" class="btn btn-sm btn-info">Xem</a>
                                            </td>
                                        </tr>
                                    </c:forEach>                                    
                                    </tbody>									                          

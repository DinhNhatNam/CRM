									...
									<tbody>
										...
										<c:if test="${listTask!=null}">
											<c:forEach items="${listTask}" var="i">
												<tr>
													<td>1</td>
													<td><c:out value="${i.getId_CongViec().getName()}" /></td>
													<td><c:out
															value="${i.getId_CongViec().getId_duan().getName()}" /></td>
													<td><c:out
															value="${i.getId_NguoiDung().getFullname()}" /></td>
													<td><c:out
															value="${i.getId_CongViec().getNgaybatdau()}" /></td>
													<td><c:out
															value="${i.getId_CongViec().getNgayketthuc()}" /></td>
													<td><c:out
															value="${i.getId_CongViec().getTrangthai().getTen()}" /></td>

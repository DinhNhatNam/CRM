		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
					...
					<li><a href="403.jsp" class="waves-effect"><i
			...
			<div class="container-fluid">
				...
				<div class="row">
							...
							<div class="user-bg">
								...
								<div class="overlay-box">
									<div class="user-content">
										...
										<h4 class="text-white">${listInfo.get(0).getId_NguoiDung().getFullname()}</h4>
										<h5 class="text-white">${listInfo.get(0).getId_NguoiDung().getEmail()}</h5>
									</div>
								</div>
							</div>
					...
					<div class="col-md-8 col-xs-12">
						...
						<c:forEach items="${listInfo}" var="listJob">
							<c:choose>
								<c:when test="${listJob.getId_CongViec().getTrangthai().getId() == 1}">
									<% x += 1; %>
								</c:when>
							</c:choose>
							<c:choose>
								<c:when test="${listJob.getId_CongViec().getTrangthai().getId() == 2}">
									<% y += 1; %>
								</c:when>
							</c:choose>
							<c:choose>
								<c:when test="${listJob.getId_CongViec().getTrangthai().getId() == 3}">
									<% z += 1; %>
								</c:when>
							</c:choose>					
						</c:forEach>
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="white-box">
									<div class="col-in row">
										<div class="col-xs-12">
											<h3 class="counter text-right m-t-15 text-danger"><%=x%>%</h3>
										</div>
										<div class="col-xs-12">
										...
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="progress">
												<div class="progress-bar progress-bar-danger"
													...
													aria-valuemax="100" style="width: <%=x%>%"></div>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="white-box">
									<div class="col-in row">
										<div class="col-xs-12">
											<h3 class="counter text-right m-t-15 text-megna"><%=y%>%</h3>
										</div>
										<div class="col-xs-12">
										...
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="progress">
												<div class="progress-bar progress-bar-megna"
													role="progressbar" aria-valuenow="40" aria-valuemin="0"
													aria-valuemax="100" style="width: <%=y%>%"></div>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="white-box">
									<div class="col-in row">
										<div class="col-xs-12">
											<h3 class="counter text-right m-t-15 text-primary"><%=z%>%</h3>
										</div>
										<div class="col-xs-12">
											<i class="linea-icon linea-basic" data-icon="&#xe00b;"></i>
										...
										<div class="col-md-12 col-sm-12 col-xs-12">
											<div class="progress">
												<div class="progress-bar progress-bar-primary"
													role="progressbar" aria-valuenow="40" aria-valuemin="0"
													aria-valuemax="100" style="width: <%=z%>%"></div>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="white-box">
							...
							<div class="message-center">
								<c:forEach items="${listInfo}" var="listJob">
									<c:if test="${listJob.getId_CongViec().getTrangthai().getId() == 1}">
										<a href="#">
											<div class="mail-contnet">
												<h5>${listJob.getId_CongViec().getName()}</h5>
												<span class="mail-desc"></span> <span class="time">${listJob.getId_CongViec().getNgaybatdau()}</span>
												<span class="time">${listJob.getId_CongViec().getNgaybatdau()}</span>
											</div>
										</a>
									</c:if>
								</c:forEach>
					...
					<div class="col-md-4">
						<div class="white-box">
							...
							<div class="message-center">
								<c:forEach items="${listInfo}" var="listJob">
									<c:if test="${listJob.getId_CongViec().getTrangthai().getId() == 2}">
										<a href="#">
											<div class="mail-contnet">
												<h5>${listJob.getId_CongViec().getName()}</h5>
												<span class="mail-desc"></span> <span class="time">${listJob.getId_CongViec().getNgaybatdau()}</span>
												<span class="time">${listJob.getId_CongViec().getNgayketthuc()}</span>
											</div>
										</a>
									</c:if>
								</c:forEach>
					...
					<div class="col-md-4">
						<div class="white-box">
							...
							<div class="message-center">
								<c:forEach items="${listInfo}" var="listJob">
									<c:if test="${listJob.getId_CongViec().getTrangthai().getId() == 3}">
										<a href="#">
											<div class="mail-contnet">
												<h5>${listJob.getId_CongViec().getName()}</h5>
												<span class="mail-desc"></span> <span class="time">${listJob.getId_CongViec().getNgaybatdau()}</span>
